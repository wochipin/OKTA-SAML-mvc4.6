...
namespace Saml
{
    ...
    public class Response
    {
        ...
        public bool IsValid()
        {
            ...
            //last check is commented until finding root cause of error in webservers (localhost it does work!)
            return ValidateSignatureReference(signedXml) && !IsExpired(); // && signedXml.CheckSignature(_certificate.cert, false);
        }
